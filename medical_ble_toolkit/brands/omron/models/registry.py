...
from medical_ble_toolkit.brands.omron.models.base import DeviceProfile
...
def _load_builtin_profiles() -> None:
    ...
    if _LOADED:
        return
    from medical_ble_toolkit.brands.omron.models.profiles.catalog import build_all_profiles

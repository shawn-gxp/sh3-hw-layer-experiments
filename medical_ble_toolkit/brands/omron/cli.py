...
CLI entry — interactive menu or argparse subcommands.
  ...
  python -m medical_ble_toolkit.brands.omron              → interactive menu
  python -m medical_ble_toolkit.brands.omron pair ...
  python -m medical_ble_toolkit.brands.omron read ...     → wait for cuff, download once
  python -m medical_ble_toolkit.brands.omron watch ...    → auto-fetch: wait longer, download, show latest
  python -m medical_ble_toolkit.brands.omron list-models
...
from medical_ble_toolkit.brands.omron import __app_name__, __version__
from medical_ble_toolkit.brands.omron.ble.scanner import pick_device_interactive
...
from medical_ble_toolkit.brands.omron.logging_config import DBG_TAG, get_logger, setup_logging
